/*jshint forin:true, noarg:true, noempty:true, eqeqeq:true, bitwise:true, strict:true, undef:true, unused:true, curly:true, browser:true, indent:4, white:false, maxerr:50 */
/**
	@file 前端用户行为跟踪
	@example

<script type="text/javascript" charset="utf-8" src="http://csdnimg.cn/pubfooter/js/tracking.js" defer="" async=""></script>
...
;(function(window, undefined) {
	...
	// 首页不收集信息
	if(loc.host === 'www.csdn.net' && loc.pathname === '/') {
		return;
	}
