...
/************************ ADDITIONAL FEATURES ************************
     Plugins
*/
var s_account="nokiaglobalfwg0qa"
...
s.linkInternalFilters="javascript:,.developer.nokia.com"
...
function s_doPlugins(s) {
	...
	{
		s.eVar26 = s.getValOnce(s.getQueryParam('intc', 'intc_cookie', 0));
		s.prop26=s.eVar26;
	}
	...
	s.eVar22=s.getValOnce(s.eVar22,'s_newrep',0);
	if (s.eVar22){ 
...
s.trackingServer="metrics.nokia.com"
s.trackingServerSecure="smetrics.nokia.com"
s.dc="112"
