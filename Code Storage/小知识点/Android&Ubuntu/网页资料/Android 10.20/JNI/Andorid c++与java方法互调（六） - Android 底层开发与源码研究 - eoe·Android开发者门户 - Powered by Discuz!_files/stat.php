...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.46158500 1319096938';
var cnzz_a=gc_cnzz("cnzz_a3473994");
...
var cnzz_sin = gc_cnzz("sin3473994");
if(cnzz_sin==-1) cnzz_sin='none';
if( cnzz_ref.split('/')[2]!=document.domain ) cnzz_sin=cnzz_ref;
var cnzz_eid=gc_cnzz("cnzz_eid");
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1319096938+"-"+cnzz_ref.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=3473994" target=_blank title="&#31449;&#38271;&#32479;&#35745;">&#31449;&#38271;&#32479;&#35745;</a>');
document.write('<img src="http://hzs21.cnzz.com/stat.htm?id=3473994'+cnzz_data+'" border=0 width=0 height=0 />');
...
document.cookie="cnzz_a3473994="+cnzz_a+";expires="+cnzz_ed.toGMTString()+ "; path=/";
document.cookie="sin3473994="+escape(cnzz_sin)+ ";expires="+cnzz_ed.toGMTString()+";path=/";
