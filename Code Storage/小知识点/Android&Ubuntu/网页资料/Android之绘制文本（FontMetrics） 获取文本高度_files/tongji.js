...
{
	var unit_id     = "1141514";
	var client_ip   = "58.218.213.182";
	var server_time = "1328862170";
	var verify_code = "26755b07";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1141514/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
