...
function google_go() {
    location.href = "http://www.google.com.hk/search?q=" + encodeURIComponent("site:www.cnblogs.com/" + blogapp + "/ " + document.getElementById('google_q').value);
    return false;
}
...
$(function () {
    ...
    if ($("#ad_text_under_commentbox").length) {
		...
		if (now < new Date('November 17,2012')) {
            adstr += '<a href="http://www.cnblogs.com/cmt/archive/2012/10/31/2747102.html" target="_blank">开发者的云计算盛会，期待您的参与（11月20日~21日，北京，免费）</a><br/>';
        }
